...
(() => {
  ...
  window.__GF_DEFAULT_ROOM = "preview";
...
`;
  ...
  async function generateGame() {
    ...
    try {
      ...
      const promptPayload = multiplayer
        ? prompt + "\n\nMake it multiplayer using GameFactoryMultiplayer with a shared room and synchronized turns/state."
        : prompt;
        ...
        <div className="hero-card">
          ...
          <div className="prompt-area">
            ...
            <div className="button-row">
              ...
              <button className={multiplayer ? "tab active" : "secondary"} onClick={() => setMultiplayer((v) => !v)}>
                {multiplayer ? "Multiplayer: On" : "Multiplayer: Off"}
              </button>
